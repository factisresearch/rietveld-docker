...
class Patch(db.Model):
  ...
  def get_patched_content(self):
    ...
    """
    # SW 2010-11-30: added the ' and self.patched_content.text' part
    # somehow, diffs between patch sets where not working but adding
    # this additional check made them work again!
    try:
      if self.patched_content is not None and self.patched_content.text:
